...
Identify semantically distinct topics. A "topic" is a cohesive area of knowledge that an agent would want to look up as a unit. Examples of good topic boundaries for imbh-go:

- A specific mechanism (e.g., "Arrow C Data Interface batch handoff", "the two-free FFI ownership protocol", "sable stream cursor lifetime")
- A cross-cutting concern (e.g., "Go/Rust toolchain pinning and linkname ABI", "combined staticlib build model")
...
- Filename (kebab-case, descriptive, e.g., `arrow-cdata-batch-handoff.md`)
...
| Document | Summary |
|----------|---------|
| [arrow-cdata-batch-handoff.md](arrow-cdata-batch-handoff.md) | How result batches cross the FFI boundary zero-copy |
| ... | ... |
```
