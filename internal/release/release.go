...
// The prebuilt assets are published under a GitHub release named after it (e.g. "v0.5.1").
...
// "libimbhgo-v0.5.1-linux-amd64.a.zst" (glibc/default) or "libimbhgo-v0.5.1-linux-amd64-musl.a.zst".
...
// libimbhgo.a is placed, e.g. "imbhgo/v0.5.1/linux-amd64" or ".../linux-amd64-musl".
