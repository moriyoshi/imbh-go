...
//
//	go run github.com/moriyoshi/imbh-go/cmd/imbhgo-fetch@v0.1.0
...
func run(args []string, stdout, stderr io.Writer) error {
	...
	fs.SetOutput(stderr)
	var o options
	fs.StringVar(&o.version, "version", resolveVersion(), "release version to fetch (e.g. v0.1.0)")
...
// a tagged version (…/cmd/imbhgo-fetch@v0.1.0); it falls back to the compiled-in release.Version for
